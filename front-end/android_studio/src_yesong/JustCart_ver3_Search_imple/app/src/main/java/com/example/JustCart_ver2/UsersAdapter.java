...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.CustomViewHolder> {
    ...
    private ArrayList<com.example.JustCart_ver2.PersonalData> mList = null;
    private Activity context = null;


    public UsersAdapter(Activity context, ArrayList<com.example.JustCart_ver2.PersonalData> list) {
