...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.CustomViewHolder> {
    ...
    private ArrayList<com.example.searchview_test.PersonalData> mList = null;
    private Activity context = null;


    public UsersAdapter(Activity context, ArrayList<com.example.searchview_test.PersonalData> list) {
